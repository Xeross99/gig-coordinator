class AddKurnikowyKomendantAndHostManagers < ActiveRecord::Migration[8.1]
  # Renumeruje istniejących `mistrz_piora` z wartości 3 na 4, a następnie
  # tworzy tabelę `host_managers`. Kolejność jest ważna: enum po tej migracji
  # mapuje wartość 3 na `kurnikowy_komendant` (nowa ranga), więc bez UPDATE

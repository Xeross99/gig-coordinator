...
ActiveRecord::Schema[8.1].define(version: 2026_08_07_130000) do
  ...
  create_table "campaign_participation_events", force: :cascade do |t|
    t.integer "campaign_participation_id", null: false
    t.datetime "created_at", null: false
    t.integer "event_type", null: false
    t.index ["campaign_participation_id"], name: "idx_cpe_on_campaign_participation_id"
    t.index ["event_type"], name: "index_campaign_participation_events_on_event_type"
  end

  create_table "campaign_participations", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "event_campaign_id", null: false
    t.integer "position", default: 0, null: false
    t.datetime "reserved_until"
    t.integer "status", default: 0, null: false
    t.datetime "updated_at", null: false
    t.integer "user_id", null: false
    t.index ["event_campaign_id", "status", "position"], name: "index_campaign_participations_on_campaign_status_position"
    t.index ["event_campaign_id", "user_id"], name: "index_campaign_participations_on_campaign_and_user", unique: true
    t.index ["event_campaign_id"], name: "index_campaign_participations_on_event_campaign_id"
    t.index ["reserved_until"], name: "index_campaign_participations_on_reserved_until"
    t.index ["user_id"], name: "index_campaign_participations_on_user_id"
  end

  create_table "carpool_offers", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "current_pickup_user_id"
    t.integer "event_id", null: false
    t.integer "trip_state", default: 0, null: false
    t.datetime "updated_at", null: false
    t.integer "user_id", null: false
    t.index ["current_pickup_user_id"], name: "index_carpool_offers_on_current_pickup_user_id"
  ...
  create_table "event_campaign_changes", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "event_campaign_id", null: false
    ...
    t.datetime "updated_at", null: false
    t.integer "user_id"
    t.index ["event_campaign_id", "created_at"], name: "index_campaign_changes_on_campaign_and_created_at"
    t.index ["event_campaign_id"], name: "index_event_campaign_changes_on_event_campaign_id"
    t.index ["user_id"], name: "index_event_campaign_changes_on_user_id"
  end
  ...
  create_table "event_campaigns", force: :cascade do |t|
    ...
    t.text "notes"
    t.datetime "updated_at", null: false
    t.index ["completed_at"], name: "index_event_campaigns_on_completed_at"
    t.index ["creator_id"], name: "index_event_campaigns_on_creator_id"
    t.index ["host_id"], name: "index_event_campaigns_on_host_id"
  end
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.integer "event_campaign_id"
    t.integer "host_id", null: false
    t.string "name", null: false
    t.text "notes"
    t.decimal "pay_per_person", precision: 8, scale: 2, null: false
    t.integer "reminder_generation", default: 0, null: false
    t.datetime "scheduled_at", null: false
    t.datetime "updated_at", null: false
    t.index ["completed_at"], name: "index_events_on_completed_at"
    t.index ["creator_id"], name: "index_events_on_creator_id"
    t.index ["ends_at"], name: "index_events_on_ends_at"
    t.index ["event_campaign_id", "scheduled_at"], name: "index_events_on_event_campaign_id_and_scheduled_at"
    t.index ["event_campaign_id"], name: "index_events_on_event_campaign_id"
  ...
  create_table "participation_events", force: :cascade do |t|
    ...
    t.index ["event_type"], name: "index_participation_events_on_event_type"
  ...
  create_table "swap_proposals", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "event_id", null: false
    ...
    t.datetime "updated_at", null: false
    t.index ["event_id", "proposer_id", "target_id"], name: "idx_swap_proposals_pending_unique", unique: true, where: "status = 0"
    t.index ["event_id", "target_id", "status"], name: "idx_swap_proposals_target_lookup"
    t.index ["event_id"], name: "index_swap_proposals_on_event_id"
    t.index ["expires_at"], name: "index_swap_proposals_on_expires_at"
    t.index ["proposer_id"], name: "index_swap_proposals_on_proposer_id"
    t.index ["target_id"], name: "index_swap_proposals_on_target_id"
  end
  ...
  add_foreign_key "campaign_participation_events", "campaign_participations", on_delete: :cascade
  add_foreign_key "campaign_participations", "event_campaigns", on_delete: :cascade
  ...
  add_foreign_key "event_campaign_changes", "event_campaigns", on_delete: :cascade
  add_foreign_key "event_campaign_changes", "users", on_delete: :nullify
  add_foreign_key "event_campaigns", "hosts"
  add_foreign_key "event_campaigns", "users", column: "creator_id", on_delete: :nullify
  add_foreign_key "event_changes", "events", on_delete: :cascade
  add_foreign_key "event_changes", "users", on_delete: :nullify
  add_foreign_key "events", "event_campaigns", on_delete: :cascade
  ...
  add_foreign_key "swap_proposals", "events"
  add_foreign_key "swap_proposals", "users", column: "proposer_id"
  add_foreign_key "swap_proposals", "users", column: "target_id"
end
